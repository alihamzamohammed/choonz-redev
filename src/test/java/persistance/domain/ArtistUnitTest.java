...
public class ArtistUnitTest {
	...
	public void equalsVerify() {
		 EqualsVerifier.forClass(Album.class).withPrefabValues(Album.class, new Album("Name", List.of(), new Artist(), List.of(), "Team 1 rules" ), new Album())
	...
	public void toStringTest() {
		...
		builder.append("Artist [id=").append(artist.getId()).append(", name=").append(artist.getName()).append(", albums=").append(artist.getAlbums())
	           .append("]");
