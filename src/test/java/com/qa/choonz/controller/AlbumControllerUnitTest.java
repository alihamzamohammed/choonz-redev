...
// @BeforeEach
// public void init() {
// List<Track> listOfTracks = Arrays.asList(new Track(1, "Till I Collapse", 298,
// "A lot of lyrics here"));
// Artist validArtist = new Artist(1, "Eminem");
// List<Genre> listOfGenres = Arrays.asList(new Genre(1, "Hip Hop", "A genre
// based around rap music."));
// validAlbum = new Album(1,"The Eminem Show", listOfTracks,validArtist,
// listOfGenres, "eminemshow.jpg");

// List<TrackRelationshipDTO> listOfTrackDTOs = Arrays.asList(new
// TrackRelationshipDTO(1, "Till I Collapse", 298, "A lot of lyrics here"));
// ArtistRelationshipDTO validArtistDTO = new ArtistRelationshipDTO(1,
// "Eminem");
// List<GenreRelationshipDTO> listOfGenreDTOs = Arrays.asList(new
// GenreRelationshipDTO(1, "Hip Hop", "A genre based around rap music."));
// validAlbumDTO = new AlbumDTO(1,"The Eminem Show",
// listOfTrackDTOs,listOfGenreDTOs,"eminemshow.jpg",validArtistDTO);
// }
...
// ResponseEntity<List<AlbumDTO>> response = new
// ResponseEntity<List<AlbumDTO>>(albumDTOs, HttpStatus.OK);
...
// ResponseEntity<AlbumDTO> response = new
// ResponseEntity<AlbumDTO>(validAlbumDTO, HttpStatus.OK);
...
// ResponseEntity<Boolean> response = new
// ResponseEntity<Boolean>(HttpStatus.NO_CONTENT);
...
// when(service.update(validAlbum,
// validAlbum.getId())).thenReturn(validAlbumDTO);

// ResponseEntity<AlbumDTO> response = new
// ResponseEntity<AlbumDTO>(validAlbumDTO, HttpStatus.ACCEPTED);

// assertThat(response).isEqualTo(controller.update(validAlbum,
// validAlbum.getId()));
