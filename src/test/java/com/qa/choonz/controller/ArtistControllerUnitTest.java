...
// ResponseEntity<List<ArtistDTO>> response = new
// ResponseEntity<List<ArtistDTO>>(artistDTOs, HttpStatus.OK);
...
// ResponseEntity<ArtistDTO> response = new
// ResponseEntity<ArtistDTO>(validArtistDTO, HttpStatus.OK);
...
// when(service.update(validArtist,
// validArtist.getId())).thenReturn(validArtistDTO);

// ResponseEntity<ArtistDTO> response = new
// ResponseEntity<ArtistDTO>(validArtistDTO, HttpStatus.ACCEPTED);

// assertThat(response).isEqualTo(controller.update(validArtist,
// validArtist.getId()));
