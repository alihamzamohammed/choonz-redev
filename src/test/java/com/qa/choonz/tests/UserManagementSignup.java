...
public class UserManagementSignup {
    ...
    public void setup() {
        extent = new ExtentReports("src/test/resources/reports/report1.html", true);// this will be called three times
        // replacing itself
    ...
    public void i_enter_the_signup_information() {
        SP.FullSignUp("TestUsername", "securePassword", "securePassword", "/signup.html");
    }
    ...
    public void i_should_be_notified_of_account_creation() {
        // when the form is submitted it will redirect to login if everything was fine
