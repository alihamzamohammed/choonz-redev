...
drop table if exists artist_contributed_tracks CASCADE;
...
create table artist_contributed_tracks (
...
alter table artist_contributed_tracks
add constraint FKonxd15s4n4r8rpaj3qoibwfyq foreign key (track_id) references track on delete cascade;
alter table artist_contributed_tracks
add constraint FKftik9kre3vjedmdym3bj631r2 foreign key (artist_id) references artist;
